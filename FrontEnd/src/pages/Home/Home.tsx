       ...
       <div className="grid grid-cols-1 items-center md:grid-cols-4 sm:grid-cols-2 gap-15 justify-center overflow-hidden">
        ...
        {/* first cart */}
        {
          ...
          <div className="flex justify-between">
            ...
            <Addtocardbutton
              title="Add to Cart"
              className="bg-white text-primary px-5 py-2"
...
{/* rounded image section */}
      ...
      <div className="flex flex-col lg:flex-row justify-between lg:items-start gap-5 md:gap-10 lg:gap-0">
        {/* text */}
    ...
    <div className="grid w-full grid-cols-1 md:grid-cols-2 gap-6 justify-items-center">
      ...
      {/* first card */}
      <div className="bg-white p-4 w-[70%] md:w-80 shadow-lg rounded-xl hover:bg-primary hover:text-white transition-colors duration-300 group">
        <div className="justify-center items-center flex flex-col gap-1">
        <img src= {images.icon1orange} alt="" className="mb-2 group-hover:filter group-hover:brightness-0 group-hover:invert transition duration-300" />
        <p className="text-sm text-primary font-bold group-hover:text-white transition duration-300">Quick delivery</p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 w-[70%] md:w-80 shadow-lg rounded-xl hover:bg-primary hover:text-white transition-colors duration-300 group">
        <div className="justify-center items-center flex flex-col gap-1">
        <img src= {images.icon2orange} alt="" className="mb-2 group-hover:filter group-hover:brightness-0 group-hover:invert transition duration-300" />
        <p className="text-sm text-primary font-bold group-hover:text-white transition duration-300">Quick delivery</p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 w-[70%] md:w-80 shadow-lg rounded-xl hover:bg-primary hover:text-white transition-colors duration-300 group">
        <div className="justify-center items-center flex flex-col gap-1">
        <img src= {images.icon3orange} alt="" className="mb-2 group-hover:filter group-hover:brightness-0 group-hover:invert transition duration-300" />
        <p className="text-sm text-primary font-bold group-hover:text-white transition duration-300">Quick delivery</p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 w-[70%] md:w-80 shadow-lg rounded-xl hover:bg-primary hover:text-white transition-colors duration-300 group">
        <div className="justify-center items-center flex flex-col gap-1">
        <img src= {images.icon4orange} alt="" className="mb-2 group-hover:filter group-hover:brightness-0 group-hover:invert transition duration-300" />
        <p className="text-sm text-primary font-bold group-hover:text-white transition duration-300">Quick delivery</p>
        </div>
      </div>
