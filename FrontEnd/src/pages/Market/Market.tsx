  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setAllProducts(productsWithDiscount.slice(0,20));
        setFilteredProducts(productsWithDiscount.slice(0,20)); // initialize filtered list
      })
    ...
    <div className="p-4 md:p-10 flex flex-col gap-10">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-5 justify-center items-start md:items-center">
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-2 overflow-x-auto pb-2 md:pb-0">
          {["All","Makeup kits","Flip","Gadget","Bag","Jewelries","Shoes"].map((cat) => (
            <Categorybutton
              key={cat}
              title={cat}
      ...
      <div className="flex justify-between items-center mt-6 mb-2">
        ...
        <div className="relative">
          <Filterbutton title="Price" className="bg-tertiary text-gray-400 px-4 py-2 shadow-lg pr-8" />
